...
namespace StandardizedQR.Services.Encoding
{
    public class MerchantEncoder : IPayloadEncoding<MerchantPayload>
    {
        public string GeneratePayload(MerchantPayload payload)
        {
            ...
            //var sr = crc.ToHex(true).GetLast(4);

            //var crc1 = new Crc(crc16ccittFalseParameters).ComputeHash(System.Text.Encoding.UTF8.GetBytes(str));
            //var sr1 = crc1.ToHex(true).GetLast(4);
